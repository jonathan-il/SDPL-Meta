...
recdExcessive = 
  let 
    hbody z = If (P LessThan (Pair (Var z) (Const 10.4)) ) (Call "h" (Op Times (Pair (Var z) (Var z)))) (Var z)
    hprog = M.insert "h" hbody M.empty 
    callhonx = Call "h" (Var 0)
    rdh = RD (0::Int) callhonx (Const 1.000000000000001) (Const 1.000000000000001)
  in 
    fullEvaluationTermInProgTotal 1 rdh hprog